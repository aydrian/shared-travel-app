...
| **`v2-oso-rbac`** ⭐ | **Oso Cloud RBAC** | **Current branch** - Role-based access control using Oso Cloud with trip-level permissions |
| `main` | Oso RBAC + ReBAC | Latest implementation with relationship-based access control for expense sharing |

### 🔍 Explore the Evolution

- **[Compare from v1](../../compare/v1-basic-rbac...v2-oso-rbac)**: See how this Oso Cloud RBAC was implemented
- **[Compare to v3](../../compare/v2-oso-rbac...main)**: See how ReBAC was added for expense sharing
- **[View latest version](../../tree/main)**: Jump to the most advanced implementation
...
**v2 (Oso RBAC)** ⭐ *Current Implementation*
